  ...
  :profiles {:uberjar {:aot      :all
             ...
             :dev     {:plugins      [[lein-eftest "0.5.9"]
                       ...
                       :dependencies [; Core clojure
                                      ...
                                      [clj-kondo "2022.05.31" :exclusions [com.fasterxml.jackson.core/jackson-core]] ; com.fasterxml.jackson.core/jackson-core is provided by com.appsflyer/donkey
                                      ...
                                      ; test containers
                                      [clj-test-containers "0.7.0" :exclusions [org.testcontainers/testcontainers]]
                                      [org.testcontainers/kafka "1.17.2" :exclusions [org.slf4j/slf4j-api]]]
