  ...
  :profiles {:uberjar {:aot      :all
             ...
             :dev     {:plugins      [[lein-eftest "0.5.9"]
                       ...
                       :dependencies [; Core clojure
                                      ...
                                      [clj-kondo "2022.06.22" :exclusions [com.fasterxml.jackson.core/jackson-core]] ; com.fasterxml.jackson.core/jackson-core is provided by com.appsflyer/donkey
                                      ...
                                      ; test containers
                                      [clj-test-containers "0.7.1" :exclusions [org.testcontainers/testcontainers]]
                                      [org.testcontainers/kafka "1.17.3" :exclusions [org.slf4j/slf4j-api]]]
